  ...
  return (
    <div className={styles.content}>
      ...
      <div className={styles.featuresGrid}>
        ...
        <div className={styles.featureCard}>
          ...
          <p className={styles.featureText}>
            ...
            needs of real off-road enthusiasts — because that's who we are too.
          </p>
        </div>
      ...
      <p className={styles.conclusion}>
        Whether you're building a rock crawler, trail rig, or overlanding setup,
        our components are engineered to perform when it matters most.
      </p>
