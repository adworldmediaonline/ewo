  ...
  return (
    <div className={styles.content}>
      ...
      <p className={styles.intro}>
        At East West Offroad Products LLC, your satisfaction is important to us.
        If for any reason you are not completely satisfied with your purchase,
        we offer a simple and transparent return policy.
      </p>
      ...
      <div>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              Items must be returned in new, unused, and uninstalled condition.
            </li>
            <li className={styles.listItem}>
            ...
            <li className={styles.listItem}>
              Returns that are damaged, used, or missing parts may be subject to
              additional fees or denied.
            </li>
          </ul>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              All returns are subject to a 15% restocking fee unless you qualify
              for a special case.
            </li>
            <li className={styles.listItem}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              Once we receive and inspect your return, we will issue a refund to
