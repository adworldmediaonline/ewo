    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <p className={styles.intro}>
          Welcome to East West Offroad Products LLC ("Company," "we," "our," or
          "us"). These Terms of Use ("Terms") govern your use of our website
          located at www.eastwestoffroad.com
        </p>
        <p className={styles.intro}>
        ...
        <div>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionText}>
              ...
              images, videos, and software, is the property of East West Offroad
              Products LLC or its licensors, and is protected by U.S. and
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionText}>
              We reserve the right to correct any errors, update information, or
              cancel orders if any information is inaccurate at any time without
              prior notice.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionText}>
              All payments must be made at the time of purchase. We accept major
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionText}>
              ...
              use of the Website or the products purchased through the Website.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionText}>
              ...
              liabilities, and expenses (including attorneys' fees) arising from
