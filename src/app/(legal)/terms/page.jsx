    ...
    <div className="">
      <div className="">
        <div className="">
          ...
          <div>
            <section className="">
              <h2 className="">1. Use of Website</h2>
              <p className="">
            ...
            <section className="">
              <h2 className="">4. Payment Terms</h2>
              <p className="">
            ...
            <section className="">
              <h2 className="">5. Shipping and Returns</h2>
              <p className="">
            ...
            <section className="">
              <h2 className="">8. Indemnification</h2>
              <p className="">
            ...
            <section className="">
              <h2 className="">9. Governing Law</h2>
              <p className="">
            ...
            <section className="">
              <h2 className="">10. Changes to Terms</h2>
              <p className="">
            ...
            <div className="">
              <h3 className="">11. Contact Information</h3>
              <p className="">
