...
/** Minimal blur placeholder for above-fold product images (perceived performance) */
const BLUR_DATA_URL =
  'data:image/jpeg;base64,';
            ...
            {imageSrc ? (
              useProxyForFilename ? (
                <Image
                  ...
                  onLoad={onLoad}
                  unoptimized
                  placeholder={loading === 'eager' ? 'blur' : undefined}
                  blurDataURL={loading === 'eager' ? BLUR_DATA_URL : undefined}
                />
              ) : (
                <CldImage
                  src={imageSrc}
